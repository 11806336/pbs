...
<div id="main">
    <form id="addForm">
        ...
        <div class="control-group ">
            ...
            <input type="text" name="day_begin" id="day_begin" readonly="readonly" onclick="WdatePicker({dateFmt:'HH:mm:ss', maxDate:'%y-%M-%d'});" value="" style="background-color: #fff;cursor:pointer;">
            <span style="display: inline-block;margin:0 10px;">至</span>
            <input type="text" name="day_end" id="day_end" readonly="readonly" onfocus="WdatePicker({dateFmt:'HH:mm:ss', maxDate:'%y-%M-%d'});" value="" style="background-color: #fff;cursor:pointer">
