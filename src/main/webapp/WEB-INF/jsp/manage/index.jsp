	...
	<ul id="menu">
		...
		<li id="logo" class="hidden-xs">
			<a href="${basePath}/manage/index">
				<img src="${basePath}/resources/pbs-admin/images/logo.png"/>
			</a>
...
<section id="main">
	...
	<aside id="sidebar">
		...
		<ul class="main-menu">
			...
			<li>
				<div class="upms-version">&copy; pbs-ams-management V1.0.0</div>
			</li>
		</ul>
		<!-- /菜单区 -->
	</aside>
	...
	<section id="content">
		...
		<div class="content_main">
			<div id="iframe_home" class="iframe cur">
				...
				<p><b>演示地址</b>：<a href="http://www.pbs.cn/ipbAdmin" target="_blank">http://www.pbs.cn/ipbAdmin</a></p>
...
<script src="${basePath}/resources/pbs-admin/plugins/waves-0.7.5/waves.min.js"></script>
<script src="${basePath}/resources/pbs-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="${basePath}/resources/pbs-admin/plugins/BootstrapMenu.min.js"></script>
<script src="${basePath}/resources/pbs-admin/plugins/device.min.js"></script>
<script src="${basePath}/resources/pbs-admin/plugins/jquery.cookie.js"></script>
<script src="${basePath}/resources/pbs-admin/js/admin.js"></script>
<script src="${basePath}/resources/pbs-admin/plugins/fullPage/jquery.fullPage.min.js"></script>
<script src="${basePath}/resources/pbs-admin/plugins/fullPage/jquery.jdirk.min.js"></script>
</body>
</html>