...
<div id="main">
    <form id="addForm">
        <div class="control-group">
            <label for="platformId" class="control-label"><em class="rqd">*</em>选择分类：</label>
            <div class="controls">
                <select name="platformId" id="platformId">
                    <option value="0">---请选择---</option>
                    <%--<c:forEach var="amsTradeFeeTemplate" items="${amsTradeFeeTemplate}">--%>
                        <%--<option value="${amsTradeFeeTemplate.stockCategoryId}">${platform.stockCategoryName}</option>--%>
                    <%--</c:forEach>--%>
                </select>
