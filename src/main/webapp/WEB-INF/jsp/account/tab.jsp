...
<section style="height:100%;">
    ...
    <div class="content_main">
        <div id="iframe_setAccountInfo" class="iframe cur">
            <iframe class="tab_iframe" src="/account/details/tab/query_tab/${amsTradeAccount.tradeAccountId}" width="100%" frameborder="0" scrolling="auto" onload="changeFrameHeight(this)"></iframe>
        </div>
