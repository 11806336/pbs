...
<head>
    ...
    <link rel="stylesheet" href="../../../../resources/pbs-admin/plugins/layer/css/layer.css">
</head>
<body>
<div id="content">
    <div id="searchDiv">
        <div class="form-group">
           ...
           <div class="btn">
                <div class="btn-panel" onclick="panel('tab.html','添加证券账号')">
                    ...
                    <a class="btn icon-plus addstockcom btn-primary" href="#" onclick="daochu()">导出全部持仓</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function actionFormatter(value, row, index) {
        ...
        return [
            ...
            "<a class='update' style='padding:0 6px;' href='javascript:;' onclick=accountDetail('inquire/tab.html','账号详情') data-toggle='tooltip' title='查看账号详情'><i class='glyphicon glyphicon-eye-open'></i></a>",
    ...
    function accountDetail(url,title){
        layer.open({
            type: 2,
            title:title,
            area: ['780px', '430px'],
