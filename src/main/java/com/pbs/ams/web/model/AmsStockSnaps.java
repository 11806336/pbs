...
public class AmsStockSnaps implements Serializable {
    /**
     * 证券ID
     *
     * @mbg.generated
    ...
    public String toString() {
        ...
        sb.append(", stockCategoryId=").append(stockCategoryId);
    ...
    public boolean equals(Object that) {
        ...
        AmsStockSnaps other = (AmsStockSnaps) that;
        return (this.getStockId() == null ? other.getStockId() == null : this.getStockId().equals(other.getStockId()))
            ...
            && (this.getStockCategoryId() == null ? other.getStockCategoryId() == null : this.getStockCategoryId().equals(other.getStockCategoryId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getStockCategoryId() == null) ? 0 : getStockCategoryId().hashCode());
